...
@WebServlet("/GetTodaysAppointmentForPatient")
public class GetTodaysAppointmentForPatient extends HttpServlet {
	boolean connectionSuccess = false;
	DBConnection connection;
	public GetTodaysAppointmentForPatient() {
        super();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	if(connectionSuccess)
    	{
			...
			int rows=0;
			System.out.println("Patient : "+patientId + " date : "+date);
			...
			try {
				...
				String sql = "select * from doctor_appointment join doctor_schedule "
						...
						+ " join doctor_detail on doctor_appointment.doctor_id = doctor_detail.doctor_id"
						+ " join clinic on doctor_appointment.clinic_id"
						+ "=clinic.clinic_id where doctor_appointment.patient_id='"+patientId+"' "
