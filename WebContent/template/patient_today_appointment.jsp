...
%>
<div ng-show="noAppointmentForToday" ng-init="getTodaysAppointment(<%=patientId %>)" class="noAppointForTodayDiv">
	<span  class="noAppointForTodayMsg">Sorry No Appointment Found For Today</span>	
</div>

<span class="doctorFoundMsg" ng-hide="noAppointmentForToday" id="scrollArea">
You have {{todaysAppointment.length}} appointments today
</span>	

<div ng-hide="noAppointmentForToday" class="doctorList" ng-style="{'margin-top':appointmentListMarginTop}">
<div class="row" ng-init="">
	<div class="row">
	 ...
	 <div class="row root-row" ng-repeat="schedule in todaysAppointment | filter : search | orderBy:sort">
