...
%>
<span class="appointRequestSent" ng-show="doctorAppointSuccess">Appointment Request has been sent</span>
<span class="doctorFoundMsg">
{{doctorToAppoint.length}} Doctors are available to appoint
<br>

</span>	

<div class="doctorList" ng-style="{'margin-top':doctorListMarginTop}">
<div class="row" ng-init="">
	<div class="row">
	 ...
	 <div class="row root-row" ng-repeat="schedule in doctorToAppoint | filter : search | orderBy:sort">
	 	...
	 	<div class="col-lg-10">
	 		<div class="col-lg-10">
		 		<div class="row">
		 			<span class="schedule-day">{{schedule.firstName}} {{schedule.lastName}}</span>
		 		</div>
		 		<div class="row">
	 		...
	 		<div class="col-lg-2">
	 			<a  data-toggle="modal" 
	 				...
	 				ng-click="assignScheduleToDoctor(schedule)">
    ...
    <!-- Modal content-->
    	<div class="modal-content">
      		<div class="modal-header" style="background:#d35400;color:#ffffff">
        		...
        		<h4 class="modal-title">Are you sure to request an appointment to this doctor?</h4>
      		</div>
      		<div class="modal-body">
        		<center>
        			<h5 style="font-weight:bold">This Operation Will Post an Appointment to This Doctor.Do You Want To Proceed?</h5>
        			<a 	style="width:15%; background:#d35400;
        				border:2px solid #d35400" 
        				class="btn btn-primary btn-md"
        				ng-click="appointDoctor(scheduleToAppoint,<%=id %>)"
        				data-dismiss="modal">
        				Yes</a>
